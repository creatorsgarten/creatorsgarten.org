...
*   [**Architecture Deep Dive (`docs/architecture.md`)**](./docs/architecture.md): Detailed insights into the packlet-based architecture, key platform features, backend API (Elysia/Eden) structure with a diagram, and external service dependencies.
